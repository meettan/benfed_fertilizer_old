...
<!-- 
                       <div class="sub-dropdown">
                        <a class="sub-dropbtn">KHRIBO <i class="fa fa-angle-right" style="float: right;"></i></a>
                        <div class="sub-dropdown-content">
                        </div>
                       </div> -->

                       <!-- <div class="sub-dropdown">
                        <a class="sub-dropbtn">IPL <i class="fa fa-angle-right" style="float: right;"></i></a>
                        <div class="sub-dropdown-content">
            ...
            <?php } ?>
                    ...
                    <div class="dropdown">
                        ...
                        <?php if( $this->session->userdata['loggedin']['ho_flag']=="Y"){?> 
                            ...
                            <a href="<?php echo site_url("irncan");?>">IRN Cancel( Within 24 Hours )</a>
                            <a href="<?php echo site_url("irncancr");?>">IRN Cancel( After 24 Hours )</a>
                            ...
                            <div class="sub-dropdown">
                              ...
                              <div class="sub-dropdown">
                               ...
                               <a href="<?php echo site_url("fert/rep/crnote_reliz_rep");?>"> Realization Report </a>
                                ...
                                <!-- <a href="<?php echo site_url("fert/rep/crsummrep_ho");?>">Credit Note Summery All</a> -->
                                    ...
                                    <!-- <a href="<?php echo site_url("fert/rep/crnote_reliz_rep");?>">Credit Note Realization Report </a>
                                    <a href="<?php echo site_url("fert/rep/crnoterep_ho");?>">Company Credit Note</a> -->
                               ...
                               <div class="sub-dropdown-content">
                                    ...
                                    <!-- <a href="<?php echo site_url("fert/rep/purrep");?>">Received From Society</a> -->
