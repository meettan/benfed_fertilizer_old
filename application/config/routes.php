...
$route['customer']         = 'fertilizer/fertilizer/soceity';                       //fo Master
$route['fomaster-add']         = 'fertilizer/fertilizer/fomasteradd';                       //Society Master
$route['fomaster-edit/(:num)']         = 'fertilizer/fertilizer/fomasteredit/$1';                       //Society Master
$route['fomaster']         = 'fertilizer/fertilizer/fomaster';                       //Society Master
$route['category']         = 'fertilizer/fertilizer/category';   
$route['key/(:any)']       = 'fertilizer/$1';                                       //Fertilizer        
$route['rateslab']         = 'fertilizer/fertilizer/sale_rate'; 
$route['api/(:any)']        = 'fertilizer/api/$1';                       //Sale Rate Salb
