	...
	class ReportModel extends CI_Model{
		...
		public function f_get_balance($branch,$frmDt,$toDt){
            // if ($opndt>='2021-04-01') {
                ...
                $data = $this->db->query("Select prod_id,ifnull(Sum(qty ),0)  as opn_qty, sum(tot_pur)tot_pur, sum(tot_sale)tot_sale,ifnull(Sum(qty ),0) + sum(tot_pur)  - sum(tot_sale) as cls_qty
            from (
