<div class="wraper">      
			...
			<div class="col-md-12 container form-wraper">
                ...
                <form method="POST"  action="<?php echo site_url("api/get_api_res_cr");?>" >
					...
					<div class="form-header">
                        ...
                        <input type="text" id=trans_ro name="trans_do" class="form-control" value="<?=$prodd->trans_do?>"/>						
						<div class="form-group row">

                             <label for="cin" class="col-sm-2 col-form-label">Sale Invoice Type:</label>
                        <div class="col-sm-4">
    
                        <select name="trans_type" class="form-control" readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                          <label for="no_of_days"  class="col-sm-2 col-form-label">No Of Days:</label>
                            <div class="col-sm-4">
                                <input type="text" style="width:100px" name="no_of_days" id="no_of_days" class="form-control" value="<?=$prodd->no_of_days?>"  onchange="endDt()" readonly />
                            </div>
                ...
                <tr>
                    ...
                    <td>
                                <select name="stock_point" id="stock_point" class="form-control stock_point" readonly>
                                            <option value="">Select</option>
                                <?php
