...
?>     
				...
				<h4>Product Details</h4>
					...
					<div class="col-sm-3">
						...
						<select name="prod_id" class="form-control sch_cd required" id="prod_id" required>
							...
							?>
							<input type="hidden" name="mnthenddt" style="width:80px" class="form-control required mnthenddt" value= "<?php echo $prod->mnthdt; ?>" id="mnthenddt" readonly>
							<?php
        ...
        <input type="text" name="unit_name" style="width:80px" class="form-control required unit_name" value= "" id="unit_name" readonly>
		 
		</div>
				<label for="storage" class="col-sm-1 col-form-label">Container:</label>
					<div class="col-sm-1">

					<input type="text" name="storage" style="width:80px" class="form-control required storage" value= "" id="storage" readonly> 

					</div>
					<label for="qtyperbag" class="col-sm-1 col-form-label">Qty Per Container:</label>
						<div class="col-sm-1">
	
						<input type="text" name="qtyperbag" style="width:80px" class="form-control required qtyperbag" value= "" id="qtyperbag" readonly> 
						</div>
...
?>     
				...
				<label for="no_of_bags" class="col-sm-1 col-form-label">No Of Container:</label>
					...
					<input type="number" style="width:150px" id=no_of_bags name="no_of_bags" class="form-control" value="0"  readonly  />
					</div> 
					...
					<input type="date" style="width:150px" id=trans_dt name="trans_dt" class="form-control" value="<?php echo set_value('trans_dt'); ?>"  />
					</div> 
				</div>
