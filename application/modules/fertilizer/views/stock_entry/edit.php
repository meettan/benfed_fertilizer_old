	...
	?>     
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					...
					<textarea style="width:580px;height:70px" id=comp_add name="comp_add" class="form-control required"
						readonly><?php echo $stock->COMP_ADD; ?>
						</textarea>
			...
			<div class="form-group row">
				...
				<div class="col-sm-1">
					...
					<input type="text" style="width:80px" name="storage" class="form-control required" value="<?php
 ...
 ?>" readonly />
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					...
					<select name="stkpnt_id" style="width:200px" class="form-control sch_cd required" id="stkpnt_id"
						required>
						...
						<?php
								...
								?>
						<option value="<?php echo $stkpnt->soc_id;?>"
							<?php if($stock->stock_point==$stkpnt->soc_id) {echo "selected"; }?>>
							<?php echo $stkpnt->soc_name;?></option>
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					...
					<input type="hidden" style="width:200px" name="challan_flag" id="challan_flag"
						class="form-control required" value="<?php echo $stock->challan_flag; ?>" />
			...
			<div class="form-group row">
				...
				<div class="col-sm-1">
					...
					<input type="checkbox" id="add_ret_margin_flag" name="add_ret_margin_flag" value="Y"
						class="checkbox_check" disabled <?php 
			...
			<div class="form-group row">
				...
				<div class="col-sm-1">
					...
					<input type="checkbox" id="add_adj_amt_flag" name="add_adj_amt_flag" value="Y" disabled <?php 
			...
			<div class="form-group row">
				...
				<div class="col-sm-2">
					...
					<input type="text" style="width:150px" id=trd_mgr name="trd_mgr" class="form-control"
						value="<?php echo $stock->trad_margin; ?>" readonly />
				...
				<div class="col-sm-2">
					...
					<input type="text" style="width:150px" id=les_oth_dis name="les_oth_dis" class="form-control"
						value="<?php echo $stock->oth_dis; ?>" readonly />
				...
				<div class="col-sm-2">
					...
					<input type="frt_subsidy" style="width:120px" id=frt_subsidy name="frt_subsidy" class="form-control"
						value="<?php echo $stock->frt_subsidy; ?>" readonly />
				...
				.done(function (data) {
					...
					$('#add_adj_amt_flag').on('click', function () {
						...
						if (ckbox3.is(':checked')) {
							taxable_amt = parseFloat(base_price) + parseFloat(retlr_margin) -
								parseFloat(spl_rebt) + parseFloat(add_adj_amt) - parseFloat(
									less_adj_amt)
							taxable_amt = parseFloat(taxable_amt).toFixed(2)
							gst = (taxable_amt * gst_rt / 100) / 2
							gst = parseFloat(gst).toFixed(2)
							...
							taxable_amt = parseFloat(base_price) + parseFloat(retlr_margin) -
								parseFloat(spl_rebt) - parseFloat(less_adj_amt)
							taxable_amt = parseFloat(taxable_amt).toFixed(2)
							gst = (taxable_amt * gst_rt / 100) / 2
							gst = parseFloat(gst).toFixed(2)
							tot_amt = parseFloat(taxable_amt) + parseFloat(gst) * 2
				...
				.done(function (data) {
					...
					$('#less_adj_amt_flag').on('click', function () {
						...
						if (ckbox4.is(':checked')) {
							...
							taxable_amt = parseFloat(base_price) + parseFloat(retlr_margin) -
								parseFloat(spl_rebt) + parseFloat(add_adj_amt)
							taxable_amt = parseFloat(taxable_amt).toFixed(2)
							gst = (taxable_amt * gst_rt / 100) / 2
							gst = parseFloat(gst).toFixed(2)
							tot_amt = parseFloat(taxable_amt) + parseFloat(gst) * 2
...
<script>
	$(document).ready(function () {
		...
		if (sale_cnt > 0) {
			...
			$('#msg').html("This RO cannot be edited.Since some items have been sold.").css("font-size", "20px",
				"color", "#0d7d8ef5");
			$('#submit').attr('type', 'buttom');
			return false;
				...
				.done(function (data) {
					...
					$('#less_trad_margin_flag').on('click', function () {
						...
						if (ckbox5.is(':checked')) {
							taxable_amt = parseFloat(base_price) + parseFloat(retlr_margin) -
								parseFloat(spl_rebt) + parseFloat(add_adj_amt) - parseFloat(
									less_adj_amt) - parseFloat(less_trad_margin)
							taxable_amt = parseFloat(taxable_amt).toFixed(2)
							gst = (taxable_amt * gst_rt / 100) / 2
							gst = parseFloat(gst).toFixed(2)
							tot_amt = parseFloat(taxable_amt) + parseFloat(gst) * 2
				...
				.done(function (data) {
					...
					$('#less_oth_dis_flag').on('click', function () {
						...
						if (ckbox6.is(':checked')) {
							...
							taxable_amt = parseFloat(base_price) + parseFloat(retlr_margin) -
								parseFloat(spl_rebt) + parseFloat(add_adj_amt) - parseFloat(
									less_adj_amt) - parseFloat(less_trad_margin) - parseFloat(
									less_oth_dis)
							taxable_amt = parseFloat(taxable_amt).toFixed(2)
							gst = (taxable_amt * gst_rt / 100) / 2
							gst = parseFloat(gst).toFixed(2)
					...
					$('#less_frght_subsdy_flag').on('click', function () {
						...
						if (ckbox7.is(':checked')) {
							taxable_amt = parseFloat(base_price) + parseFloat(retlr_margin) -
								parseFloat(spl_rebt) + parseFloat(add_adj_amt) - parseFloat(
									less_adj_amt) - parseFloat(less_trad_margin) - parseFloat(
									less_oth_dis) - parseFloat(less_frt_subsidy)
							taxable_amt = parseFloat(taxable_amt).toFixed(2)
							gst = (taxable_amt * gst_rt / 100) / 2
							gst = parseFloat(gst).toFixed(2)
							tot_amt = parseFloat(taxable_amt) + parseFloat(gst) * 2
