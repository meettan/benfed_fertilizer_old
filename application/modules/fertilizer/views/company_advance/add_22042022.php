	...
	<div class="col-md-11 container form-wraper">
		...
		<form method="POST" id="form" action="<?php echo site_url("adv/company_advAdd") ?>" >
            ...
            <label for="Receipt No" class="col-sm-2 col-form-label">Receipt No:</label>
                ...
                <label class="col-sm-2 col-form-label">Amount to Already paid</label>
...
$( document ).ajaxComplete(function() {
    $("#receipt_no").change(function(){
        ...
        success: function(data){
            var tot_amt = 0.0;
            var i  = 0; var j = 0;
            var list = '<tr><th>Sl No</th><th style="width:33%">Advance No</th><th style="width:33%">Company Name</th><th style="width:33%">Amount</th><th>Option</th></tr>';
            $.each(JSON.parse(data), function(index, value) {
                list += '<tr><td>'+ ++i +'</td><td><input type="hidden" class="form-control" value="'+value.detail_receipt_no+'" name="adv_receive_no[]" readonly>'+value.detail_receipt_no+'</td><td>'+value.COMP_NAME+'</td><td>'+value.amount+'</td><td><input type="checkbox" id="ckamt" name="ckamt['+ j++ +'][list]"  value ='+value.detail_receipt_no+' class="ckamt"></td></tr>';
