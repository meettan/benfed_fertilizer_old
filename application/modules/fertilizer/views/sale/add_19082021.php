			...
			<div class="col-md-12 container form-wraper">
				...
				<form method="POST" action="<?php echo site_url("trade/saleAdd") ?>" onsubmit="return valid_data()">
                    ...
                    <div class="form-group row">
						...
						<div class="col-sm-3">
	                    <input type="date" style="width:250px" id=ro_dt name="ro_dt" class="form-control" value="<?php echo date('Y-m-d');?>" readonly/>
    ...
    $('#prod_id').change(function(){
        ...
        $.get( 
            ...
            $.each(JSON.parse(data), function( index, value ) {
                ...
                string += '<option value="' + value.ro_no + '">' + value.ro_no +' '+value.ro_dt + '</option>'
