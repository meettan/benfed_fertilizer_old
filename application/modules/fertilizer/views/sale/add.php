<div class="wraper">      
			...
			<div class="col-md-12 container form-wraper">
				...
				<form method="POST" action="<?php echo site_url("trade/saleAdd") ?>" onsubmit="return valid_data()">
                    ...
                    <div class="form-group row">
						...
						<div class="col-sm-3">
	                    <input type="date" style="width:300px" id=ro_dt name="ro_dt" class="form-control" value="<?php echo date('Y-m-d');?>" readonly/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                            <input type="date" style="width:300px" name="sale_due_dt" id="sale_due_dt" class="form-control" readonly />
                            </div>
                        </div>
                    ...
                    <select name="prod_id" id="prod_id" style="width:250px"class="form-control sch_cd prod_id" required>
                    ...
                    <option value="">Select RO</option>
                      ...
                      <div class="form-group row">
                        ...
                        <input type="text" name="stock_name" style="width:300px" class="form-control stock_name" value= "" id="stock_name" readonly>     
                        </div>
                     </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-4"> 
                        <select name="gov_sale_rt" id="gov_sale_rt" style="width:300px" class="form-control gov_sale_rt" required>
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-4"> 
            <input type="text" name="mrp_gst" id="mrp_gst"  style="width:250px" class="form-control required mrp_gst" value= "0" id="mrp_gst" readonly> 
            </div>
            </div>
            <div class="form-group row">
            <!-- <div class="col-sm-4">  -->
            ...
            <div class="col-sm-4">
            <input type="text" name="sale_rtgst" id="sale_rtgst"  style="width:250px" class="form-control required sale_rtgst" value= "0" id="mrp_gst" readonly> 
            </div>
            
            <label for="sp_bag_gst"  class="col-sm-2 col-form-label">Sales Price Per<br> Bag With GST:</label> 
            <div class="col-sm-4">
            <input type="text" name="sp_bag_gst" id="sp_bag_gst"  style="width:250px" class="form-control required sp_bag_gst" value= "0" id="mrp_gst" readonly> 
            </div>
                        </div>
    ...
    $('#prod_id').change(function(){
        ...
        $.get( 
            ...
            $.each(JSON.parse(data), function( index, value ) {
                ...
                string += '<option value="' + value.ro_no + '">'+ value.ro_dt +'| |'+value.ro_no +'</option>'
