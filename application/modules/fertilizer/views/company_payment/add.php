				...
				<form method="POST" action="<?php echo site_url("compay/company_payAdd") ?>" onsubmit="return valid_data()" id="form">
                    ...
                    <div class="form-group row">
						...
						<div class="col-sm-4">
							...
							<select name="dist_id" style="width:250px" class="form-control sch_cd required" id="dist_id" required>
                        ...
                        <table class= "table table-striped table-bordered table-hover">
                            ...
                            <tbody id= "intro">
                                <tr>
                                    ...
                                    <td>
                                      <input type="text" name="rate[]" style="width:100px;" class="form-control rate rate_change" value= "" id="rate"  readonly>
                                    </td>
                                    <td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td colspan="">
                                        <input name="taxable_total" style="width:150px;" id="taxable_total" class="form-control taxable_total" placeholder="Taxable Total" readonly>  
                                    </td>
                                    <td colspan="">
                                        <input name="tds_total" style="width:150px;" id="tds_total" class="form-control tds_total" placeholder="TDS Total" readonly>  
                                    </td>
                                    <td colspan="">
                                        <input name="total" style="width:150px;" id="total" class="form-control total" placeholder="Total" readonly>  
                                    </td>
                                    <td colspan="">
                                        <input name="net_total" style="width:150px;" id="net_total" class="form-control net_total" placeholder="NET Total" readonly>  
                                    </td>
                                </tr>
                            </tfoot>
...
$(document).ready(function()
{
    $('#intro').on( "change", ".pur_inv", function()                     
    {
        ...
        //  $('.rate').eq($('.pur_inv').index(this)).val(unitData.purchase_rt); 
         ...
         $('.taxable_amt').eq($('.pur_inv').index(this)).val(parseFloat(unitData.taxable_amt).toFixed('2'));      
         $('.tds').eq($('.pur_inv').index(this)).val(unitData.tds);      
