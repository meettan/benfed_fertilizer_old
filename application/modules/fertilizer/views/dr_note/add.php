...
<!-- </div> -->
                    ...
                    <div class="form-group row">
						...
						<div class="col-sm-4">
						<input type="date" id="trans_dt" name="trans_dt" value="<?php echo set_value('trans_dt'); ?>" class="form-control" required />
	                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <table class= "table table-striped table-bordered table-hover">
                            ...
                            <?php
                                    ...
                                    <td>
                                      <input type="text" name="tot_amt[]" id="tot_amt" style="width:130px;" class="form-control amt" value= "" id="tot_amt" >
                                    </td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <input name="total" style="width:150px;" id="total" class="form-control total" readonly>  
                                    </td>
                                </tr>
                            </tfoot>
