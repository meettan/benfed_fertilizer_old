...
<div class="col-sm-4">
<input type="text" id="inv_no" name="trans_dt" class="form-control" value="<?php echo $dr_dtl->invoice_no; ?>" readonly />
</div>
...
<div class="form-group">
    ...
    <table class= "table table-striped table-bordered table-hover">
        ...
        <?php
                ...
                <td>
                  <input type="text" name="tot_amt[]" id="tot_amt" style="width:130px;" class="form-control tot_amt" value="<?php echo $dr_dt->tot_amt; ?>" readonly id="tot_amt" >
                </td>
