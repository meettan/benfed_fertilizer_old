                                    ...
                                    <td class="report">
                                        ...
                                        if($sal->unit==1){
                                           ...
                                           $totsld_sal+=$sal_qty;
                                            ...
                                            $sal_qty=($sal->qty)*($sal->qty_per_bag)/1000; 
                                            $totlqd_sal+=$sal_qty;
                                           }
                                        ...
                                        <?php 
                                            ...
                                            //     if($prodtls->prod_id==$opndtls->prod_id){
                                                    if($sal->unit==1){
                                                        ...
                                                        echo ceil(number_format((float)($sal_qty*1000 )/$sal->qty_per_bag,3,'.',''));                                                      
                                                       
                                                    }elseif($sal->unit==2){
                                                           echo ceil(number_format((float)( $sal_qty*1000)/$sal->qty_per_bag,3,'.',''));                                          
                                                    }elseif($sal->unit==4){
                                                        echo ceil(number_format((float)( $sal_qty)*100/$sal->qty_per_bag,3,'.',''));
                                                       
                                                    }elseif($sal->unit==6){
                                                       echo ceil(number_format((float)( $sal_qty)*1000/$sal->qty_per_bag,3,'.',''));
                                                    }elseif($sal->unit==3){
                                                     echo ceil(number_format((float)( $sal_qty)/$sal->qty_per_bag,3,'.',''));
