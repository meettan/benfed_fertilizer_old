<div class="wraper">      
	...
	<div class="col-md-11 container form-wraper">
		...
		<form method="POST" id="product" action="<?php echo site_url("adv/editadv") ?>" >
			...
			<input id="cshbank"  name="cshbank" type="radio" class="radio-label" <?php if($advDtls->cshbnk_flag=='0') echo "checked='checked'"; ?> value="0"  disabled/>
			
                <label for="cshbank" class="radio-label">Cash</label>
			</div>
				<div class="col-sm-2">
                <input id="cshbank" name="cshbank" type="radio" class="radio-label"  <?php if($advDtls->cshbnk_flag=='1') echo "checked='checked'"; ?>value="1" disabled/>
