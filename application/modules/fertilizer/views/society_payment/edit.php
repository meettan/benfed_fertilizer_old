        ...
        <form method="POST" action="<?php echo site_url("socpay/society_payEdit");?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    ...
                    <textarea style="width:590px" name="remarks" id="remarks"
                ...
                <div class="form-group">
                    ...
                    { ?>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="ref_dt[]" class="form-control required ref_dt"
                                        value="<?=$pay->ref_dt?>" id="ref_dt">
                                </td>
                                <td>
                                    <input type="text" name="ref_no[]" class="form-control required ref_no"
                                        value="<?=$pay->ref_no?>" id="ref_no">
                                </td>

                                <td>
                                    <input type="text" name="paid_amt[]" class="form-control required paid_amt"
