<div class="wraper">      
			...
			<div class="col-md-10 container form-wraper">
                    ...
                    <?php    }    ?>     
                      ...
                      <label for="tot_recvble_amt" class="col-sm-2 col-form-label">Total Invoice RO Amount:</label>
                        ...
                        <input type="text" style="width:180px" id="net_amt" name="net_amt"value="0"  class="form-control" readonly />
                         ...
                         <div class="col-sm-2">
                        <input id="cshbank"  name="cshbank" type="radio" class="radio-label" value="0" checked />
			
                <label for="cshbank" class="radio-label">Cash</label>
			</div>
				<div class="col-sm-2">
                <input id="cshbank" name="cshbank" type="radio" class="radio-label"  value="1"/>
               ...
               <div class="form-group row">
                        ...
                        <select name="bnk_id" style="width:180px" class="form-control bnk_id" id="bnk_id" disabled>
                    <option value="">Select</option>
                    <?php
                       foreach($bnk_dtls as $bnk){
                            ?>
