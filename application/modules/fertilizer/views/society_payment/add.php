			...
			<div class="col-md-10 container form-wraper">
                ...
                <!-- <form method="POST" action="<?php echo site_url("socpay/society_payAdd") ?>"onsubmit="myFunction()" id="form"> -->
                    ...
                    <div class="form-group row">
						...
						<input type="date" style="width:200px" id="paid_dt" name="paid_dt" class="form-control" required/>
	                    </div>
                        <!-- </div> -->
                      </div>
                    ...
                    <?php    }    ?>     
                      ...
                      <label for="tot_recvble_amt" class="col-sm-2 col-form-label">Total Invoice RO Amount:</label>
						...
						<input type="text" style="width:150px" id="tot_recvble_amt" name="tot_recvble_amt" value="0" class="form-control" readonly />
	                    </div>
                
						<!-- <div class="col-sm-3"> -->
                        <input type="text" style="width:150px" id="rndtot_recvble_amt" name="rndtot_recvble_amt"value="0"  class="form-control" readonly />
                        <!-- </div> -->
                        </div>
                        <div class="form-group row">
                        ...
                        <input type="text" style="width:180px" id="net_amt" name="net_amt"value="0"  class="form-control" readonly />
                         ...
                         <div class="col-sm-2">
                        <input id="cshbank"  name="cshbank" type="radio" class="radio-label" value="0"  />
			
                <label for="cshbank" class="radio-label">Cash</label>
			</div>
				<div class="col-sm-2">
                <input id="cshbank" name="cshbank" type="radio" class="radio-label"  value="1" checked />
...
<!-- }                  if($('#cshbank').val()=='1'){ -->
                 ...
                 <select name="pay_type[]" id="pay_type" style="width:230px"class="form-control pay pay_type" required>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#addrow').click(function(){
			...
			if(cashbank == 0){
			var ovalue ='<option value="">Select Pay Type</option><option value="1">Cash</option><option value="2">Advance</option><option value="6">CR Note</option>';
			}else{
			var ovalue ='<option value="">Select Pay Type</option><option value="2">Advance</option><option value="3">Cheque</option><option value="4">Draft</option><option value="5">Pay Order</option><option value="6">CR Note</option><option value="7">NEFT/RTGS</option>';
			}
...
$(document).ready(function(){
    ...
    $('#intro').on("change", ".paid_amt", function(){
        ...
        if(parseFloat(total) > parseFloat(rnd_net_amt))
        {
            ...
            alert('Paid Amount Should Not Greater Total Invoice RO Amount!');
            $('#submit').prop('disabled', true);
