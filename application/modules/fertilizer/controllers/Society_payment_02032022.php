...
// if($trans_type==2 || $trans_type==6){
	
	$tot_sundry += $_POST['paid_amt'][$i];
}else{
	$tot_soc += $_POST['paid_amt'][$i];
}

 if ($trans_type=='2'){
	// echo $_POST['pay_type'][$i];
	// exit;
	// if ($_POST['pay_type'][$i]=='2'){
					...
					if ($trans_type=='2'){
						...
						//$this->Society_paymentModel->f_recvjnl_cr($data_cr_fin);
					}
					...
					$data2     = array(   
                      ...
                      // if ($trans_type=='6'){
						...
						// $data_dr_cr_note     = array('recpt_no' => $crreceipt ,

						// 							'soc_id'      =>  $this->input->post('soc_id'),
	
						// 							'trans_dt'    =>  date('Y-m-d'),

						// 							"trans_no"	  =>  $crtransNo->trans_no,													

						// 							'tot_amt'      => $this->input->post('tot_dr_amt'),
